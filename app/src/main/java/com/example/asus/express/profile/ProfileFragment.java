...
import com.example.asus.express.login.LoginActivity;
...
public class ProfileFragment extends Fragment {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mAccount==null){
                    ...
                    Toast.makeText(getActivity(),R.string.log_out_toast,Toast.LENGTH_SHORT).show();
                    updateButton();
                }
            }
        });
    ...
    public void updateButton(){
        ...
        if(mAccount!=null){
            mLoginBtn.setText(R.string.btn_log_out);
